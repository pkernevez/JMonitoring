...
public class TestStackTraceTracer extends TestCase
{
    ...
    public void testGetStackTrace()
    {
        ...
        assertEquals("    at org.jmonitoring.core.info.impl.StackTraceTracer.getStackTrace(StackTraceTracer.java:",
            tTok.nextToken().substring(0, 91));
        assertEquals(
            "    at org.jmonitoring.core.info.impl.TestStackTraceTracer.testGetStackTrace(TestStackTraceTracer.java:",
            tTok.nextToken().substring(0, 103));
    }
