...
public abstract class MethodCallAbstractDTO<T>
{
     ...
     */
    public void setChildren(T[] pChildren)
    {
        children = pChildren;
    }
    ...
    {
        return getClass().getName() + " flowId=" + getFlowId() + " , position=" + getPosition();
    }
