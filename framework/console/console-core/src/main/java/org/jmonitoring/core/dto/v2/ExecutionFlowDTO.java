...
import org.jmonitoring.core.dto.v2.MethodCallDTO;
...
public class ExecutionFlowDTO implements Serializable
{
    ...
    private String mBeginDateAsString;

    /** End datetime. */
    private Date mEndTime;

    private String mEndTimeAsString;
     ...
     */
    public void setBeginDateAsString(String pBeginTime)
    {
        mBeginDateAsString = pBeginTime;
    }
     ...
     */
    public void setEndTimeAsString(String pEndTime)
    {
        mEndTimeAsString = pEndTime;
    }
