...
//    {
//        ColorHelper tConfig =  ColorHelper.getInstance();
//        
...
//        assertEquals(ExecutionFlowDAO.class, ColorHelper.getInstance().getExecutionFlowDaoClass());
//        
//    }
//    
