...
public class GenericConnection implements Connection
{
    ...
    public GenericConnection(Connection pRealConnection, String pGroupName)
    {
        super();
    ...
    {
        return new JMonitoringStatement(mRealConnection.createStatement(), groupName);
    }
        ...
        throws SQLException
    {
        return new JMonitoringStatement(mRealConnection.createStatement(pResultSetType, pResultSetConcurrency,
                                                                        pResultSetHoldability), groupName);
    }
        ...
        int pResultSetHoldability) throws SQLException
    {
        return new JMonitoringCallableStatement(mRealConnection.prepareCall(pSql, pResultSetType,
                                                                            ...
                                                                            pResultSetHoldability), pSql, groupName);
    }
        ...
        throws SQLException
    {
        ...
        return new JMonitoringCallableStatement(tStat, pSql, groupName);
    }
    ...
    {
        return new JMonitoringCallableStatement(mRealConnection.prepareCall(pSql), pSql, groupName);
    }
        ...
        int pResultSetHoldability) throws SQLException
    {
        ...
        return new JMonitoringPreparedStatement(tStat, pSql, groupName);
    }
