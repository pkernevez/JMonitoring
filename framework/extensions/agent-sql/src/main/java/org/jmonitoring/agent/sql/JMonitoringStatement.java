...
public class JMonitoringStatement implements Statement, IProxyStatement
{
    ...
    public JMonitoringStatement(Statement pRealStatement, String pGroupName, Filter pFilter)
    {
        this(pRealStatement, pGroupName, true, pFilter);
    }

    public JMonitoringStatement(Statement pRealPreparedStat, String pGroupName, boolean pLog, Filter pFilter)
    {
        if (pLog)
        {
    ...
    public boolean execute(String pSql) throws SQLException
    {
        ...
        tManager.logBeginOfMethod(EXECUTE_STR, null, new Object[0], groupName, this);
        try
        {
    ...
    public boolean execute(String pSql, int pAutoGeneratedKeys) throws SQLException
    {
        mTrace.append("Sql=[").append(pSql).append("]\n");
        StoreManager tManager = getStoreManager();
        tManager.logBeginOfMethod(EXECUTE_STR_INT, null, new Object[0], groupName, this);
        try
        {
    ...
    public boolean execute(String pSql, int[] pColumnIndexes) throws SQLException
    {
        mTrace.append("Sql=[").append(pSql).append("]\n");
        StoreManager tManager = getStoreManager();
        tManager.logBeginOfMethod(EXECUTE_STR_TINT, null, new Object[0], groupName, this);
        try
        {
    ...
    public boolean execute(String pSql, String[] pColumnNames) throws SQLException
    {
        mTrace.append("Sql=[").append(pSql).append("]\n");
        StoreManager tManager = getStoreManager();
        tManager.logBeginOfMethod(EXECUTE_STR_TSTR, null, new Object[0], groupName, this);
        try
        {
    ...
    public int[] executeBatch() throws SQLException
    {
        ...
        StoreManager tManager = getStoreManager();
        tManager.logBeginOfMethod(EXECUTE_BATCH, null, new Object[0], groupName, this);
        try
        {
    ...
    public int executeUpdate(String pSql, int pAutoGeneratedKeys) throws SQLException
    {
        mTrace.append("Execute Update=[").append(pSql).append("]\n");
        StoreManager tManager = getStoreManager();
        tManager.logBeginOfMethod(EXECUTE_UPDATE_STR_INT, null, new Object[0], groupName, this);
        try
        {
    ...
    public int executeUpdate(String pSql, int[] pColumnIndexes) throws SQLException
    {
        mTrace.append("Execute Update=[").append(pSql).append("]\n");
        StoreManager tManager = getStoreManager();
        tManager.logBeginOfMethod(EXECUTE_UPDATE_STR_TINT, null, new Object[0], groupName, this);
        try
        {
    ...
    public int executeUpdate(String pSql, String[] pColumnNames) throws SQLException
    {
        mTrace.append("Execute Update=[").append(pSql).append("]\n");
        StoreManager tManager = getStoreManager();
        tManager.logBeginOfMethod(EXECUTE_UPDATE_STR_TSTR, null, new Object[0], groupName, this);
        try
        {
    ...
    {
        return new JMonitoringResultSet(mRealStatement.getGeneratedKeys(), groupName, mFilter);
    }
    ...
    public ResultSet getResultSet() throws SQLException
    {
        ...
        return (tResultSet == null ? null : new JMonitoringResultSet(tResultSet, groupName, mFilter));
    }
