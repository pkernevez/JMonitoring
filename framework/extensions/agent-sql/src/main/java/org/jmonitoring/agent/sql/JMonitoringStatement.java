...
public class JMonitoringStatement implements Statement, IProxyStatement
{
    ...
    public JMonitoringStatement(Statement pRealStatement, String pGroupName)
    {
        this(pRealStatement, pGroupName, true);
    }

    public JMonitoringStatement(Statement pRealPreparedStat, String pGroupName, boolean pLog)
    {
        if (pLog)
        {
    ...
    {
        return new JMonitoringResultSet(mRealStatement.getGeneratedKeys(), groupName);
    }
    ...
    public ResultSet getResultSet() throws SQLException
    {
        ...
        return (tResultSet == null ? null : new JMonitoringResultSet(tResultSet, groupName));
    }
