...
/**
 * Form associated with <code>MeasurePoint</code>.
 * 
 * @author pke
 */
public class MeasurePointForm extends ActionForm
{
     ...
     */
    public void setMeasurePoint(MeasurePoint pMeasurePoint)
    {
        mMeasurePoint = pMeasurePoint;
    }

    /**
     * Return the ids of the parent <code>MeasurePoint</code>.
    ...
    /**
     * Return the ids of the current <code>MeasurePoint</code>.
     * This <code>Map</code> is used for the link generation by Struts.
     * @return The list of attributes to use for the link.
     */
    ...
    /**
     * Return the ids of a chid of the <code>MeasurePoint</code>.
     * This <code>Map</code> is used for the link generation by Struts.
     * @param pPosition The index of the <code>MeasurePoint</code>.
     * @return The list of attributes to use for the link.
     */
    public Map getChildMeasureIdsMap(int pPosition)
    {
        Map tHashMap = new HashMap();
        MeasurePoint tMeasure = (MeasurePoint) mMeasurePoint.getChildren().get(pPosition);
